...
\end{minipage}
\caption{Classification error evidence for the ResNet-18 baseline: confusion matrix and representative mistakes. The dominant errors occur between visually similar breeds.}
\label{fig:classification_errors}
\end{figure*}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.98\textwidth]{assets/segmentation_error_cases.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{assets/detection_yolo11m_img960_metrics.png}
\caption{YOLO11m validation metrics on VisDrone. The manually truncated run still achieved the best recorded score at epoch 36.}
\label{fig:detection_metrics}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{assets/detection_yolo11m_img960_losses.png}
\caption{YOLO11m training and validation losses. The losses were still decreasing slowly, suggesting possible remaining improvement with more epochs.}
\label{fig:detection_losses}
\end{figure}
