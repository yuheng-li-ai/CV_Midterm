...
\begin{minipage}{0.34\textwidth}
\centering
\includegraphics[width=\linewidth]{assets/classification_resnet18_baseline_analysis/test_mistakes.png}
\end{minipage}
\hfill
...
\end{minipage}
\captionof{figure}{Representative classification mistakes from the pretrained ResNet-18 baseline. The tall grid is paired with text instead of being forced beside a wide matrix, avoiding the previous aspect-ratio mismatch.}
...
\centering
\includegraphics[width=\linewidth]{assets/segmentation_60_loss_mask_grid.png}
\end{minipage}
\hfill
...
\end{minipage}
\captionof{figure}{Qualitative mask examples for the required segmentation losses. The panel places visual evidence and interpretation side by side to avoid a mostly empty image-only page.}
...
\centering
\includegraphics[width=\linewidth]{assets/segmentation_error_cases.png}
\end{minipage}
\hfill
...
\end{minipage}
\captionof{figure}{YOLOv8n training summary on VisDrone with adjacent interpretation.}
...
\end{minipage}
\captionof{figure}{YOLOv8s training summary on VisDrone with compact explanation.}
...
\captionof{figure}{YOLO11m validation metrics and losses on VisDrone. The manually truncated run still achieved the best recorded score at epoch 36, while the losses were still decreasing slowly, suggesting possible remaining improvement with more epochs.}
